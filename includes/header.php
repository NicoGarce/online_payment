...
<header class="pay-header">
  <div class="pay-header-inner">
    ...
    <nav class="pay-nav" id="payNav">
      <a href="<?= $payments_base ?>new-enrollee" class="pay-nav-link <?= in_array($current,['guest','new-enrollee'])?'active':'' ?>">New Enrollees</a>
      <a href="<?= $payments_base ?>enrolled" class="pay-nav-link <?= in_array($current,['guestold_student','enrolled'])?'active':'' ?>">Enrolled</a>
      <a href="<?= $payments_base ?>other" class="pay-nav-link <?= in_array($current,['guestold','other'])?'active':'' ?>">Other</a>
